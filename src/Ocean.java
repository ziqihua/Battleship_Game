...
public class Ocean implements OceanInterface {
    ...
    public void placeAllShipsRandomly() {
        ...
        // Create a list of ships to be placed
     ...
     */
    public void print() {
        System.out.println("Your current Ocean grid looks like this: ");
        ...
        // Print the game board with row numbers along the left edge
        for (int row = 0; row < 10; row++) {
            System.out.print(row + " ");
            for (int col = 0; col < 10; col++) {
                ArrayList<Boolean> hitList = new ArrayList<>();
                for (boolean hitOrNot : ships[row][col].hit) {
                    hitList.add(hitOrNot);
                }
                if (!hitList.contains(true)) {
                    ...
                    int index;
                    if (ships[row][col].horizontal) {
                        index = col - ships[row][col].bowColumn;
                    } else {
                        index = row - ships[row][col].bowRow;
                    }
                    if (hitList.get(index)) {
                        System.out.print(ships[row][col].toString() + " ");
                    } else {
                        System.out.print(". ");
                    }
